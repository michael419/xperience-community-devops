...
# Compress-Archive -Path "$PSScriptRoot\App_Data\CDRepository\@global", "$PSScriptRoot\App_Data\CDRepository\repository.config" -DestinationPath "$PSScriptRoot\App_Dat
